...
class GameComponent extends React.Component {
  constructor(props) {
    ...
    this.newPlayerAdded=this.newPlayerAdded.bind(this);
  }
  newPlayerAdded(value) {
    this.setState({
      newPlayer: value
    });
  }
  ...
  render() {
    ...
    {
      overlay =
      React.createElement("div", { className: "snake-app__overlay" },
      // React.createElement("input",{className:"form-control",
      // onChange:this.state.newPlayer,
      ...
      overlay =
      React.createElement("div", { className: "snake-app__overlay" },
      React.createElement("div", { className: "mb-1" }, React.createElement("b", null, "GAME OVER!")),
      React.createElement("div", { className: "mb-1" }, "Your score: ", this.state.snake.length, " "),
      React.createElement("button", { onClick: this.startGame }, "Start a new game"));
    }
    return (
      ...
      overlay,
      React.createElement("div", { className: "mb-1" }, "score: ", this.state.snake.length, " "),
      React.createElement("div", {
        className: "grid",
        style: {
          width: this.props.size + "px",
